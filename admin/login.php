...
<html>
    ...
    <body >
        ...
        <div class="form-box" id="login-box">
            <div class="header"><div class="bg-logo"><span style="font-size: 1.3em !important;"><strong>Nation Star Academy</strong></span><br>The Brightest Generation For The Nation </div></div>
