...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Nation Star Academy</title>
    ...
    <body class="skin-blue">
        ...
        <header class="header">
           ...
           <div style="font-weight:bold; text-align:center;">Nation Star Acedemy</div>
               <div style="font-size:12px; font-weight:bold; color:#ccc; text-align:center">The Brightest Generation <br>For The Nation</div>
