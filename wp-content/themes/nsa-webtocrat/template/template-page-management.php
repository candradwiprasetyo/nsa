			...
			<div class="wrapcontentpage">
				...
				<div class="leftside">
					<div class="nsasubmenu bg_profile">
						...
						<ul>
							...
							<li><a class="active" href="<?php echo home_url(); ?>/?page_id=60" title="Management">Management</a></li>
				...
				<div class="rightside">
					...
					<h2></h2>
						...
						$query = mysql_query("select * from profiles where profile_type_id = '5' order by profile_id asc ");
