<?php
/**
Template Name: Page - Board of Trustees
*/
			...
			<div class="wrapcontentpage">
				...
				<div class="leftside">
					<div class="nsasubmenu bg_profile">
						...
						<ul>
							...
							<li><a  class="active" href="<?php echo home_url(); ?>/?page_id=55" title="Board of Trustees">Board of Trustees</a></li>
				...
				<div class="rightside">
					...
					<?php
						...
						$query = mysql_query("select * from profiles where profile_type_id = '4' order by profile_id asc ");
