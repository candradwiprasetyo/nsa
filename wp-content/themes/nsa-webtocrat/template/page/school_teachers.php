            ...
            <div class="container">
				...
				<div class="col-md-6">
							...
							<h2><?= ucwords($row['eg_name']) ?></h2>
			                	...
			                	<?php
			                    $q_adm2 = mysql_query("select * from education_grade_teachers where egm_id = '".$_GET['egm_id']."'  order by egt_id ");
								while($r_adm2 = mysql_fetch_array($q_adm2)){
								?>
			                  	
									<div class="box-showcase_new2">
										<a class="fancybox" href="<?php echo home_url(); ?>/wp-content/uploads/images/teachers/<?= $r_adm2['img'] ?>" data-fancybox-group="gallery" title="<?= $r_adm2['name'] ?>">
			                            <div class="box-showcaseInner_new2">
			                                
			                                <img src="<?php echo home_url(); ?>/wp-content/uploads/images/teachers/<?= $r_adm2['img'] ?>" alt="" />
