			...
			<div class="wrapcontentpage">
				...
				<div class="leftside">
					<div class="nsasubmenu bg_profile">
						...
						<ul>
							...
							<li><a class="active" href="<?php echo home_url(); ?>/?page_id=54" title="Values">Values</a></li>
				...
				<div class="rightside">
					...
					<?php
						include 'conf.php';
						$no = 1;
						$query = mysql_query("select * from profiles where profile_type_id = '3' order by profile_id asc ");
