			...
			<div class="wrapcontentpage">
				...
				<div class="rightside">
					...
					if(isset($_GET['sub_page_id'])){ 
						...
						<a class="more" href="<?php echo home_url(); ?>/?page_id=95" title="">Back</a>
						<br>
						</div>
					...
					<div class="wrap_inner_content borderbot">
						<div class="rs_left">
							<div class="bot">
								<a href="<?php echo home_url(); ?>/?page_id=95&sub_page_id=<?= $row['news_id']?>" title="Lorem Ipsum">
									<img src="<?php echo home_url(); ?>/wp-content/uploads/images/<?= $row['news_img'] ?>" alt="" />
								</a>
							</div>
						</div>
						<div class="rs_right">
							<a href="<?php echo home_url(); ?>/?page_id=95&sub_page_id=<?= $row['news_id']?>" title="Lorem Ipsum"><h2><?= $row['news_name'] ?></h2></a>
							<p>
								<?php
							...
							<a class="more" href="<?php echo home_url(); ?>/?page_id=95&sub_page_id=<?= $row['news_id']?>" title="Read More">Read More</a>
						</div>
