...
/**
    ...
    -> Globaling & defining '$require_plugins' from 'require-plugins.php'
    -> Remove 'screen_icon()' to passing Theme-Check v.20140929.1 with ThemeForest-Check
...
add_action( 'tgmpa_register', 'webtocrat_register_required_plugins' );
/**
...
function webtocrat_register_required_plugins() {
