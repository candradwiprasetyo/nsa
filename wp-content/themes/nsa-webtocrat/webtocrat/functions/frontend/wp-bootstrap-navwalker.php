...
/**
    ...
    Edited by BAS - Webtocrat Motion
    -> Add support for icomoon
...
class wp_bootstrap_navwalker extends Walker_Nav_Menu {
	...
	public function start_lvl( &$output, $depth = 0, $args = array() ) {
		...
		$output .= "\n$indent<ul role=\"menu\" class=\" submenu dropdown-menu\">\n";
	}
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		webtocrat_enqueue_style('webtocrat-font-icomoon');
		...
		if ( strcasecmp( $item->attr_title, 'divider' ) == 0 && $depth === 1 ) {
			...
			*/
			...
			if($args->has_children && $depth === 0 ) { $class_names .= ' sub dropdown'; } elseif($args->has_children && $depth > 0) { $class_names .= ' dropdown-submenu'; }
			...
			$item_output .= ( $args->has_children && 0 === $depth ) ? ' <i class="fa fa-angle-down r"></i></a>' : '</a>';
